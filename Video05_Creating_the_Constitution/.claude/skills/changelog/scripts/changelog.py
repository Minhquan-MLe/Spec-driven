#!/usr/bin/env python3
"""Maintain CHANGELOG.md from git commit history, scoped to this project's
directory (this repo has a single top-level .git shared by multiple
sibling projects, so history is filtered with a `-- .` pathspec)."""
