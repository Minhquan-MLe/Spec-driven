...
> **Where things live:** the app is in [`Video05_Creating_the_Constitution/`](Video05_Creating_the_Constitution/).
> Run every command below from that folder, and read file paths (`src/`, `specs/`, `.env.example`) as relative to it:
>
> ```
